...
console.log("noseX = " + noseX +" ,noseY =  "+ noseY);
  ...
  if(gameConfig.status==='start'){
    ...
    textSize(40);
    textAlign(CENTER);
    text("Press The PLAY button to start the game..... Yay☺=D ", gameConfig.screenX/2, gameConfig.screenY/2);
    textSize(40);
...
function changeGameStatud(character){
  if(gamestatus == "start" && noseX !="" && gameConfig.status==="start") {
    ...
    // document.getElementById("status").innerHTML = "The game has begun...Good Luck☻!!!!!!!";
  }
...
function manualControl(character){
  ...
  if(character.live){
    ...
    if(!noseX < 400 && !noseX > 400 && !noseY < 300){ 
